...
/* The Google Cloud lockup, from Wikimedia Commons.

   The original styles its paths through a <style> block of `.cls-N` rules.
   An inline <style> inside an SVG leaks to every other SVG on the page, so
   the classes are explicit fills here instead -- and the wordmark grey became
   `currentColor`, so it reads on the dark stage and on the light one without
   shipping two files. The cloud keeps its four brand colours. */
